      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4 mt-1">
            <Link
              ...
              aria-label="Facebook de Barklean"
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram de Barklean"
              className="text-white/70 hover:text-white transition-colors"
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 mt-5">
            <Link
              href={`tel:${BRAND.phone.replace(/\s/g, "")}`}
              className="inline-flex items-center gap-2 bg-brand-primary hover:bg-brand-dark text-white text-xs font-semibold rounded-full px-4 py-2 transition-colors w-fit"
            >
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white text-xs font-semibold rounded-full px-4 py-2 transition-colors w-fit"
            >
